...
export class FriendshipService {
    ...
    constructor(@Inject('FRIENDSHIP_REPOSITORY') private friendshipRepository: Repository<Friendship>){}
    ...
    async create(friendship : {
        ...
        try{
            const validatedFriendship = this.friendshipObjectValidator.parse(friendship)
